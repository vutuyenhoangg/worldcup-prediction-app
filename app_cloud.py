...
Tài liệu
Trên đây là toàn bộ code app hiện tại của tôi. Tôi muốn chỉnh sửa hiển thị 2 box ngôi sao trên hình riêng cho giao diện điện thoại. Tôi muốn đẩy phần nội dung ra sát lề bên trái hơn 1 chút và cố định size để 2 box hoàn toàn bằng nhau về kích thược. Chú ý chỉ sửa cho giao diện điện thoại, tuyệt đối không đụng tới các phần khác

Trong code của bạn, phần 2 box sao đang nằm trong hàm render_star_balance, dùng 2 stylable_container key là hope_star_balance_card và super_star_balance_card. Mình sẽ chỉ chỉnh CSS trong hàm này, và toàn bộ thay đổi mobile được khóa trong @media (max-width: 768px), nên desktop không bị đụng tới.

Bạn hãy thay nguyên hàm render_star_balance(user_id: int) hiện tại bằng hàm dưới đây:
...
def render_star_balance(user_id: int):
    ...
    with stylable_container(
        key="star_balance_mobile_layout",
        css_styles="""
        {
            width: 100%;
            max-width: 100%;
        ...
        @media (max-width: 768px) {
            {
                --wc-star-card-mobile-width: clamp(136px, calc((100vw - 58px) / 2), 156px);
                --wc-star-card-mobile-height: 150px;
                width: 100% !important;
            ...
            div[data-testid="stHorizontalBlock"] {
                ...
                grid-template-columns:
                    var(--wc-star-card-mobile-width)
                    var(--wc-star-card-mobile-width) !important;
            ...
            div[data-testid="column"] {
                width: var(--wc-star-card-mobile-width) !important;
                min-width: var(--wc-star-card-mobile-width) !important;
                max-width: var(--wc-star-card-mobile-width) !important;
                flex: 0 0 var(--wc-star-card-mobile-width) !important;
        ...
        @media (max-width: 390px) {
            {
                --wc-star-card-mobile-width: clamp(132px, calc((100vw - 50px) / 2), 148px);
                --wc-star-card-mobile-height: 150px;
            }
        ...
        with col_hope:
            with stylable_container(
                ...
                @media (max-width: 768px) {
                    {
                        width: var(--wc-star-card-mobile-width, 156px) !important;
                        min-width: var(--wc-star-card-mobile-width, 156px) !important;
                        max-width: var(--wc-star-card-mobile-width, 156px) !important;
                        height: var(--wc-star-card-mobile-height, 150px) !important;
                        min-height: var(--wc-star-card-mobile-height, 150px) !important;
                        max-height: var(--wc-star-card-mobile-height, 150px) !important;
...
Phần cần chỉnh nhanh sau này nằm ở đây:

--wc-star-card-mobile-width: clamp(136px, calc((100vw - 58px) / 2), 156px);
--wc-star-card-mobile-height: 150px;

Muốn nội dung sát trái hơn nữa thì giảm padding-left trong mobile từ 15px xuống 13px hoặc 12px.
...
min-width: 180px;
">
<div style=" color: #64748B; font-size: 12px; font-weight: 800; margin-bottom: 5px; ">
Trạng thái
</div>
<div style="
color: {status_info["badge_text"]};
